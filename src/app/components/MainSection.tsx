    ...
    <section className="w-full landing-bg grid grid-row-2 lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center text-center px-8 lg:text-left  lg:pr-8">
        ...
        <button className="flex justify-center text-xl pb-20 lg:justify-start ">
          <Link
            className="bg-amber-950/90 text-amber-50 hover:bg-amber-800 dark:bg-amber-100/80 dark:text-neutral-950 dark:hover:bg-amber-100 transition ease-out duration-200 w-60 h-16 pt-4 rounded-md flex justify-center content-center "
